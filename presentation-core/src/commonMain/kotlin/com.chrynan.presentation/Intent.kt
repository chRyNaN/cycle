...
/**
 * Represents the desire to perform an action. A [View] emits [Intent]s via the [View.intents] function. These
 * [Intent]s can be the result of User interaction. For instance, consider the User scrolls to the bottom of a list,
 * an [Intent] could be emitted from the [View.intents] function indicating that we intend to load more items into the
 * list.
 *
